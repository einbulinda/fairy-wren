-- ============================================================================
-- Z-Report: Add added_bills and paid_bills detail arrays to outstanding object
-- Fixes the drill-down modal that was returning empty because these arrays
-- were added after the original 20260409_004 migration was already applied.
-- Created: 10/04/2026 - einbulinda
-- ============================================================================
