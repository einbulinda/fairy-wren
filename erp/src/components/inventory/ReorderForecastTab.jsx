        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 bg-surface-800 border border-surface-700 rounded-lg px-3 py-1.5">
            ...
            <input
              ...
              className="bg-transparent text-sm text-surface-200 placeholder:text-surface-500 focus:outline-none w-44"
            />
          </div>
        </div>
      </div>
                ...
                return (
                  ...
                  >
                      ...
                      <span
                        className={`text-sm font-medium ${
                          Number(item.current_stock) <= 0
                            ? "text-red-400"
                            : Number(item.current_stock) < Number(item.projected_weekend_demand)
                            ? "text-orange-400"
                            : "text-white"
                        }`}
                      >
                    ...
                    <td className="px-3 py-3 text-right">
                      <span
                        className={`text-sm font-medium ${
                          isWeekendHeavy ? "text-primary-400" : "text-surface-400"
                        }`}
                      >
                    ...
                    <td className="px-3 py-3 text-right">
                      <span
                        className={`text-sm font-bold ${
                          item.reorder_qty > 0 ? "text-red-400" : "text-emerald-400"
                        }`}
                      >
                        {item.reorder_qty > 0
